...
contract AnemoiPresale is SafeMath{
    // Fund deposit address
    address public ethFundDeposit = "#placeholder#";                              
    address public owner;                                       // Owner of the pre sale contract
    mapping (address => uint256) public whiteList;

    // presale parameters
    bool public isFinalized;                                    // switched to true in operational state
    uint256 public constant maxLimit =  5000 ether;            // Maximum limit for taking in the money
    uint256 public constant minRequired = 10 ether;            // Minimum contribution per person
    ...
    function() payable {           
      ...
      require (msg.value >= minRequired);                        // The contribution needs to be above 10 Ether
